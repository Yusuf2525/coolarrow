...
client.on("ready", () => {
  client.user.setGame(prefix + 'yardım | Bakım Bitti | Yeni Özellikler Geldi Bakmak İçin ca!yenilikler  ! |' )
...
bot.on('guildMemberAdd', member => {
  ...
  .setTimestamp()
  .setDescription('')
  .setImage(`https://cdn.discordapp.com/attachments/468415413231812619/524551628376899584/hg.gif`)
